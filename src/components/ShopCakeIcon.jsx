        ...
        <>
            <div className="grid grid-cols-2 grid-rows-2 lg:flex lg:flex-row lg:gap-10 ml-auto">
                <div className="bg-white h-15 lg:h-30 w-auto p-5 rounded-3xl flex flex-col items-center justify-center">
                    <img src={IconCakeImage} className="h-10 w-10 lg:h-20 lg:w-20 object-center object-cover" />
                    <div>
                ...
                <div className="bg-white h-15 lg:h-30 w-auto p-5 rounded-3xl flex flex-col items-center justify-center">
                    <img src={IconCakeImage2} className="h-10 w-10 lg:h-20 lg:w-20 object-center object-cover" />
                    <div>
                ...
                <div className="bg-white h-15 lg:h-30 w-auto p-5 rounded-3xl flex flex-col items-center justify-center">
                    <img src={IconCakeImage3} className="h-10 w-10 lg:h-20 lg:w-20 object-center object-cover" />
                    <div>
                ...
                <div className="bg-white h-15 lg:h-30 w-auto p-5 rounded-3xl flex flex-col items-center justify-center">
                    <img src={IconCakeImage4} className="h-10 w-10 lg:h-20 lg:w-20 object-center object-cover" />
                    <div>
